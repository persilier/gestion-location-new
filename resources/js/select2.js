(function () {
    ...
    function i(l) {
        ...
        var t =
                "https://laravelui.spruko.com/tailwind/ynex/build/assets/images/faces/select2",
            e = $(
                '<span><img src="' +
                    t +
                    "/" +
                    l.element.value.toLowerCase() +
    ...
    function r(l) {
        if (!l.id) return l.text;
        var t = $(
            '<span><img src="https://laravelui.spruko.com/tailwind/ynex/build/assets/images/faces/select2/' +
                l.element.value.toLowerCase() +
                '.jpg"  alt="img"> ' +
                l.text +
                "</span>",
        ...
        document
            ...
            .addEventListener("click", () => {
                ...
                $(".select2-client-search").select2({
                    ...
                    $(".js-programmatic-enable").on("click", function () {
                        $(".js-example-disabled").prop("disabled", !1),
                            $(".js-example-disabled-multi").prop(
                                "disabled",
                                !1,
                            );
                    }),
