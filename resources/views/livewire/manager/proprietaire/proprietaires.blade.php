                ...
                <div class="box-body space-y-2">
                    ...
                    <div class="overflow-hidden table-bordered">
                            ...
                            <table class="table whitespace-nowrap min-w-full">
                                <thead class="bg-primary/10">
                                    <tr class="border-b border-primary/10 uppercase">
                                        <th wire:click='doSort("nom")' scope="col" class="text-start">
                                            <x-datatable-item columnName="nom" :sortField="$sortField" :sortDirection="$sortDirection" />
                                        </th>
                                        ...
                                        <th wire:click='doSort("typeProprio")' scope="col" class="text-start">
                                            <x-datatable-item columnName="typeProprio" :sortField="$sortField"
                                        ...
                                        <th wire:click='doSort("ifu")' scope="col" class="text-start">
                                            <x-datatable-item columnName="ifu" :sortField="$sortField" :sortDirection="$sortDirection" />
                                        </th>
                                            ...
                                            <tr class="border-b border-primary/10">
                                                <td>
                                                    <div class="flex items-center">
                                                        ...
                                                        </span>{{ $proprietaire->user->nom }}{{ ' ' }}{{ $proprietaire->user->prenom }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge !rounded-full bg-secondary/10 text-secondary"">{{ $proprietaire->user->email }}</span>

                                                </td>
                                                <td>
                                                    <span
                                                        class="badge !rounded-full bg-danger/10 text-danger uppercase"">{{ $proprietaire->typeProprio }}</span>

                                                </td>
                                                <td>
                                                    <span
                                                        class="badge !rounded-full bg-secondary/10 text-secondary"">{{ $proprietaire->user->tel }}</span>

                                                </td>
                                                <td>

                                                    <span
                                                        class="badge  uppercase bg-success/10 text-success' ">{{ $proprietaire->ifuProprio }}</span>
                                                ...
                                                <td>
                                                    <div class="hstack flex gap-3 text-[.9375rem]">
                                                        ...
                                                        <button type="button"
                                                            wire:click.prevent="deleteConfirmation({{ $proprietaire->id }})"
                        ...
                        <div class="flex items-center w-full justify-between my-3">
                            ...
                            @endif
                            <div>
                                {{ $proprietaires->links('pagination::new-pagination') }}
                            </div>
                        </div>
                    </div>
                </div>
