                    ...
                    <div class="sm:flex items-start p-6  main-profile-cover">
                        ...
                        <div class="flex-grow main-profile-info">
                            ...
                            <p class="text-[0.75rem] text-white mb-6 opacity-[0.5]">
                                ...
                                <span class="inline-flex"><i class="ri-map-pin-line me-1 align-middle"></i>Washington
                                    D.C</span>
                            </p>
                            <div class="flex mb-0">
                                <div class="me-6">
                    ...
                    <div class="p-6 border-b border-dashed dark:border-defaultborder/10">
                        <div class="mb-6">
                            ...
                            <p class="text-[0.75rem] text-[#8c9097] dark:text-white/50 opacity-[0.7] mb-0">
                                I am <b class="text-defaulttextcolor">Sonya Taylor,</b> here by conclude that,i am the
                                founder and managing director of the prestigeous company name laugh at all and acts as
                                the cheif executieve officer of the company.
                            </p>
                        </div>
                        <div class="mb-0">
                            ...
                            <div class="mb-0">
                                ...
                                <p class="mb-0">
                                    <a href="javascript:void(0)" class="text-primary"><u>https://themeforest.net/user/
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-2">
                                                        <b>You</b> Commented on <b>alexander taylor</b> post <a
                                                            ...
                                                            class="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">24,Dec
                                                            2022 - 14:34</span>
                                                    </p>
                                            ...
                                            <li>
                                                <div>
                                                    ...
                                                    <p class="text-[#8c9097] dark:text-white/50 mb-2">
                                                        <span class="text-default"><b>Json Smith</b> reacted to the
                                                            post 👍</span>.<span
                                                            class="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">18,Dec
                                                            2022 - 12:16</span>
                                                    </p>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-[#8c9097] dark:text-white/50 mb-2">
                                                        <span class="text-default"><b>Alicia Keys</b> shared a document
                                                            ...
                                                            class="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">21,Dec
                                                            2022 - 15:32</span>
                                                    </p>
                                                    <p
                                                        ...
                                                        <span
                                                            class="text-[.6875rem] text-[#8c9097] dark:text-white/50">432.87KB</span>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
                                                <div>
                                                    ...
                                                    <p class="text-[#8c9097] dark:text-white/50 mb-4">
                                                        <span class="text-default"><b>You</b> shared a post with 4
                                                            people <b>Simon,Sasha, Anagha,Hishen</b></span>.<span
                                                            class="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">28,Dec
                                                            2022 - 18:46</span>
                                                    </p>
                                                    <p class="profile-activity-media mb-4">
                                                        <a aria-label="anchor" href="javascript:void(0);">
                                                            <img src="/assets/images/media/media-75.jpg"
                                                                alt="">
                                                        </a>
                                                    </p>
                                                    <div>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-[#8c9097] dark:text-white/50 mb-1">
                                                        <span class="text-default"><b>Melissa Blue</b> liked your post
                                                            ...
                                                            class="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">11,Dec
                                                            2022 - 11:18</span>
                                                    </p>
                                                    <p class="text-[#8c9097] dark:text-white/50">you are already
                                                        feeling the tense atmosphere of the video playing in the
                                                        background</p>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-1">
                                                        <b>You</b> Commented on <b>Peter Engola</b> post <a
                                                            class="text-secondary"
                                                            href="javascript:void(0);"><u>#Mother Nature</u></a>.<span
                                                            class="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">24,Dec
                                                            2022 - 14:34</span>
                                                    </p>
                                                    <p class="text-[#8c9097] dark:text-white/50">Technology id
                                                        developing rapidly kepp uo your work 👌</p>
                                                    <p class="profile-activity-media mb-0 flex w-full mt-2 sm:mt-0">
                                                        <a aria-label="anchor" href="javascript:void(0);">
                                        ...
                                        <ul class="list-group !rounded-md">
                                                        ...
                                                        <div class="rounded border dark:border-defaultborder/10">
                                                            <div class="p-4 flex items-start flex-wrap">
                                                                ...
                                                                <div class="flex-grow">
                                                                    ...
                                                                    <p
                                                                        class="text-[.6875rem] mb-2 text-[#8c9097] dark:text-white/50">
                                                                        24, Dec - 04:32PM</p>
                                                                    <p
                                                                        ...
                                                                        adipisicing elit.</p>
                                                                    <p
                                                                        class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-4">
                                                            ...
                                                            <div class="p-4 flex items-start flex-wrap">
                                                                ...
                                                                <div class="flex-grow">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        26, Dec - 12:45PM</p>
                                                                    <p
                                                                        class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-1">
                                                                ...
                                                                <div>
                                                                    <div class="flex items-start">
                                                                        <div>
                                                                            <span
                                                                                class="badge bg-success/10 text-secondary me-2">Nature</span>
                                                                        </div>
                                                                        <div>
                                                                            <div class="hs-dropdown ti-dropdown">
                                                                                <button aria-label="button"
                                                        ...
                                                        <div class="rounded border dark:border-defaultborder/10">
                                                            <div class="p-4 flex items-start flex-wrap">
                                                                ...
                                                                <div class="flex-grow">
                                                                    ...
                                                                    <p
                                                                        class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-1">
                                                                        Sharing an article that excites me about nature
                                                                        more than what i thought.</p>
                                                        ...
                                                        <div class="rounded border dark:border-defaultborder/10">
                                                            <div class="p-4 flex items-start flex-wrap">
                                                                ...
                                                                <div class="flex-grow">
                                                                    ...
                                                                    <p
                                                                        class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-1">
                                                                        Followed this author for top class themes with
                                                                        best code you can get in the market.</p>
                                                                    <p class="mb-4 profile-post-link">
                                                                        <a href="javascript:void(0);"
                                                                            class="text-[0.75rem] text-primary">
                                            ...
                                            <li class="list-group-item">
                                                <div class="text-center">
                                                    <button type="button"
                                                        class="ti-btn ti-btn-primary !font-medium">Show All</button>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
