        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">{{ __('Liste des permissions') }}</h5>
                    <button type="button"
                        wire:click="$dispatch('openModal', { component: 'admin.permissions.permission-modal' })"
                ...
                <div class="box-body space-y-2">
                    ...
                    <div class="overflow-hidden table-bordered">
                                    ...
                                    @if ($permissions->count() !== 0)
                                        @foreach ($permissions as $permission)
                                            <tr class="border-b border-primary/10">
                                                <th scope="row" class="text-start">{{ $permission->id }}</th>
                                                <td>
                                                    <span
                                                        class="badge !rounded-full uppercase bg-primary/10 text-primary"">{{ $permission->name }}</span>

                                                </td>
                                                <td><span
                                                        class="badge bg-success/10 text-success">{{ $permission->created_at }}</span>
                                                </td>
                                                <td>
                                                    <div class="hstack flex gap-3 text-[.9375rem]">
                                                        <button class="ti-btn ti-btn-sm ti-btn-info !rounded-full"
                                                            wire:click="$dispatch('openModal', { component: 'admin.permissions.permission-modal',  arguments: { permission: {{ $permission->id }} } })"><i
                                                                class="ri-edit-line"></i></button>
                                                        <button type="button"
                                                            wire:click.prevent="deleteConfirmation({{ $permission->id }})"
                        ...
                        <div class="flex items-center w-full justify-between my-3 px-5">
                            ...
                            @endif
                            <div class="">
                                {{ $permissions->links('pagination::new-pagination') }}
                            </div>
                        </div>
                    </div>
                </div>
