@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="pagination-style-1">
        <div class="ti-pagination mb-0">
            ...
            @else
                <a href="{{ $paginator->previousPageUrl() }}" class="page-item disabled rtl:rotate-180">
                    {!! __('pagination.previous') !!}
                </a>
            @endif
