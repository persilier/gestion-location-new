@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="pagination-style-2">
        <div class="ti-pagination mb-0 flex-wrap">
            @if ($paginator->onFirstPage())
                <span class="page-link px-3 py-[0.375rem] !border-0">
