            ...
            <ul class="main-menu">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="projects-overview.html" class="side-menu__item">Projects
                                        Overview</a>
                                </li>
                                <li class="slide">
                                    <a href="projects-create.html" class="side-menu__item">Projects
                                        Create</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="job-company-search.html" class="side-menu__item">Job Search
                                        Company</a>
                                </li>
                                <li class="slide">
                                ...
                                <li class="slide">
                                    <a href="job-candidate-search.html" class="side-menu__item">Job
                                        Candidate Search</a>
                                </li>
                                <li class="slide">
                                    <a href="job-candidate-details.html" class="side-menu__item">Job
                                        Candidate Details</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="crypto-buy-sell.html" class="side-menu__item">Buy &amp;
                                        Sell</a>
                                </li>
                                <li class="slide">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="chartjs.html" class="side-menu__item">Chart JS</a>
                        </li>
                        <li class="slide"><a href="echartjs.html" class="side-menu__item">Echarts</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="google-maps.html" class="side-menu__item">Google
                                Maps</a></li>
                        <li class="slide"><a href="leaflet-maps.html" class="side-menu__item">Leaflet
                                Maps</a></li>
                        <li class="slide"><a href="vector-maps.html" class="side-menu__item">Vector
                                Maps</a></li>
                    </ul>
                </li>
                <!-- End::slide -->
