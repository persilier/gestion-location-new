<div id="hs-overlay-switcher" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right" tabindex="-1">
    ...
    <div class="ti-offcanvas-footer sm:flex justify-between">
        <a href="https://themeforest.net/item/ynex-laravel-tailwind-admin-dashboard-template/49617469" target="_blank"
            class="w-full ti-btn ti-btn-primary-full m-1">Buy Now</a>
