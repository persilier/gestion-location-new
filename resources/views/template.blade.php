                                    ...
                                    <thead>
                                        <tr class="border border-inherit border-solid dark:border-defaultborder/10">
                                            <th scope="row" class="!ps-4 !pe-5"><input class="form-check-input"
                                                    ...
                                                    aria-label="..."></th>
                                            <th scope="col" class="!text-start !text-[0.85rem] min-w-[200px]">Sales
                                                Rep</th>
                                            <th scope="col" class="!text-start !text-[0.85rem]">
                                                Category</th>
                                            <th scope="col" class="!text-start !text-[0.85rem]">Mail
                                            </th>
                                            <th scope="col" class="!text-start !text-[0.85rem]">
                                                Location</th>
                                            <th scope="col" class="!text-start !text-[0.85rem]">Date
                                            </th>
                                            <th scope="col" class="!text-start !text-[0.85rem]">
                                                Action</th>
                                        </tr>
