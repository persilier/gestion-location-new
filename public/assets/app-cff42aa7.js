(function () {
    ...
    document.querySelectorAll(".box-remove").forEach((e) => {
        e.addEventListener("click", function (t) {
            return t.preventDefault(), this.closest(a).remove(), !1;
        });
    }),
        document.querySelectorAll(".box-fullscreen").forEach((e) => {
            e.addEventListener("click", function (t) {
                ...
                return (
                    r.classList.toggle("box-fullscreen"),
                ...
                n.preventDefault(),
                    ...
                    document.getElementById("allCartsContainer") &&
                        ((document.getElementById("cart-data").innerText =
                            `${document.getElementById("allCartsContainer").children.length} Items`),
                    ...
                    document.getElementById("allCartsContainer") &&
                        document.getElementById("allCartsContainer").children
                            .length == 0 &&
                    ...
                    document.getElementById("allNotifyContainer") &&
                        document.getElementById("allNotifyContainer").children
                            .length == 0 &&
                        (document.getElementById(
                            "allNotifyContainer",
                        ).parentNode.innerHTML = `
        ...
        document.querySelectorAll(".dropdown-item-close").forEach((e) => {
            e.addEventListener("click", (t) => {
                if (
                    ...
                    (document.getElementById("cart-data").innerText =
                        `${document.querySelectorAll(".dropdown-item-close").length} Items`),
                    (document.getElementById("cart-icon-badge").innerText =
                        `${document.querySelectorAll(".dropdown-item-close").length}`),
                    console.log(
                        document.getElementById("header-cart-items-scroll")
                            .children.length,
                    ),
                    document.querySelectorAll(".dropdown-item-close").length ==
                        0)
                    ...
                    n.classList.add("hidden"), r.classList.remove("hidden");
                }
            });
        }),
            ...
            e.addEventListener("click", (t) => {
                if (
                    ...
                    (document.getElementById("notifiation-data").innerText =
                        `${document.querySelectorAll(".dropdown-item-close1").length} Unread`),
                    (document.getElementById(
...
setInterval(() => {
    document.querySelectorAll(".count-up").forEach((l) => {
        l.getAttribute("data-count") >= i && ((i = i + 1), (l.innerText = i));
    });
}, 10);
