(function () {
    ...
    document.getElementById("switcher-rtl").addEventListener("click", c),
        document.getElementById("switcher-ltr").addEventListener("click", i),
        document.getElementById("reset-all").addEventListener("click", i),
