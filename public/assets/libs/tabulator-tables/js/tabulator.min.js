...
!(function (e, t) {
    ...
    class t {
        ...
        getParentColumn() {
            return (
                this._column.parent instanceof n &&
    ...
    class n extends e {
        ...
        mapDefinitions() {
            ...
            if (e)
                for (let t in e)
                    void 0 === this.definition[t] &&
                        (this.definition[t] = e[t]);
        ...
        getComponent() {
            return (
                this.component || (this.component = new t(this)), this.component
            );
        }
    }
    ...
    class r {
        ...
        static deepClone(e, t, i = []) {
            var s = {}.__proto__,
                o = [].__proto__;
            for (var n in (t ||
                (t = Object.assign(Array.isArray(e) ? [] : {}, e)),
            e)) {
                let r,
                    a,
                    l = e[n];
    ...
    class a {
        ...
        generate(e, t = {}) {
            ...
            for (let e in t)
                i.hasOwnProperty(e) ||
                    (s &&
                        console.warn("Invalid " + this.msgType + " option:", e),
                    (i[e] = t.key));
            for (let e in i)
                e in t
                    ? (i[e] = t[e])
        ...
        scrollToRowPosition(e, t, i) {
            ...
            return new Promise((a, l) => {
                if (s > -1) {
                    if (
                        (void 0 === i &&
                            (i = this.table.options.scrollToRowIfVisible),
                        !i &&
                            r.elVisible(o) &&
                            (n =
                                r.elOffset(o).top -
                                r.elOffset(this.elementVertical).top) > 0 &&
                            n <
                    ...
                    switch (
                        (void 0 === t &&
                            (t = this.table.options.scrollToRowPosition),
                        "nearest" === t &&
                            (t = this.scrollToRowNearestTop(e)
                                ? "top"
                                : "bottom"),
                        this.scrollToRow(e),
                        t)
                ...
                this.table.columnManager.columnsByIndex.forEach((e) => {
                    ...
                    e.visible &&
                        (e.modules.frozen ||
                            ...
                            s + t > this.vDomScrollPosLeft &&
                            s < this.vDomScrollPosRight
                                ? (-1 == this.leftCol &&
                          ...
                          if ("group" !== e.type) {
                              ...
                              e
                                  ...
                                  .insertBefore(
                                      t.getElement(),
                                      e
                                          .getCell(this.columns[this.rightCol])
            ...
            for (var e = !1, t = !0; t; ) {
                ...
                if (i)
                    if (i.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft) {
                        ...
                        t &&
                            ((this.scrollLeft =
                                this.elementVertical.scrollLeft =
    ...
    class c extends e {
        ...
        scrollToColumn(e, t, i) {
            ...
            return new Promise((a, l) => {
                if (
                    (void 0 === t &&
                        (t = this.table.options.scrollToColumnPosition),
                    void 0 === i &&
                        (i = this.table.options.scrollToColumnIfVisible),
                    e.visible)
                ) {
                    switch (t) {
                        case "middle":
            ...
            return (
                ...
                new Proxy(this, {
                    get: function (e, t, i) {
                        return void 0 !== e[t]
                            ? e[t]
                            : e._row.table.componentFunctionBinder.handle(
                                  "row",
                                  e._row,
                                  t,
                              );
    ...
    class p extends e {
        ...
        getComponent() {
            return (
                this.component || (this.component = new u(this)), this.component
            );
        }
    }
    class m extends l {
                ...
                (c = (g - e + 1) * this.vDomRowHeight) < E &&
                    ...
                    (e -= l =
                        Math.min(
                            Math.max(
                                Math.floor(
                                    this.vDomWindowBuffer / this.vDomRowHeight,
                                ),
                ...
                for (
                    ...
                    n.appendChild(o),
                        ...
                        f.forEach((e) => {
                            (d = e.getHeight()),
                                v < l ? (u += d) : (h += d),
                                d > this.vDomWindowBuffer &&
                                    (this.vDomWindowBuffer = 2 * d),
                                v++;
                        }),
        ...
        _addTopRow(e, t) {
                        ...
                        ? ((l = d.getHeight() || this.vDomRowHeight),
                          ...
                          t >= l
                              ? (this.styleRow(d, n),
                                ...
                                (d.initialized && d.heightInitialized) ||
                                    s.push(d),
                                d.initialize(),
                                h ||
            ...
            this._quickNormalizeRowHeight(s),
                o &&
                    ((this.vDomTopPad -= o),
                    this.vDomTopPad < 0 &&
                        (this.vDomTopPad = n * this.vDomRowHeight),
    ...
    class b extends e {
        ...
        initializePlaceholder() {
            ...
            if (
                ...
                if (
                    (t.classList.add("tabulator-placeholder"),
                    "string" == typeof e)
                ) {
            ...
            return new Promise((s, o) => {
                t && this.getDisplayRows().length
                    ...
                    : (this.table.options.autoColumns &&
                          ...
                          this.table.columnManager.generateColumnsFromRowData(
                              e,
                          ),
                      this.resetScroll(),
                      this._setDataActual(e)),
        ...
        refreshActiveData(e, t, i) {
            ...
            if (!this.table.destroyed) {
                if ("function" == typeof e)
                    if (
                        (n = this.dataPipeline.findIndex(
                            (t) => t.handler === e,
                        )) > -1
                    )
                        (o = "dataPipeline"),
                            t &&
                                (n == this.dataPipeline.length - 1
                                    ? (o = "display")
                                    : n++);
                    else {
                        if (
                            !(
                                (n = this.displayPipeline.findIndex(
                                    (t) => t.handler === e,
                                )) > -1
                            )
                        )
                        ...
                        (o = "displayPipeline"),
                            t &&
                                (n == this.displayPipeline.length - 1
                                    ? (o = "end")
                                    : n++);
                    }
                else (o = e || "all"), (n = 0);
                ...
                case "displayPipeline":
                    for (let e = i; e < this.displayPipeline.length; e++) {
                        let t = this.displayPipeline[e].handler(
                            (e
                                ? this.getDisplayRows(e - 1)
                                : this.activeRows
                            ).slice(0),
                            s,
                        );
                        this.setDisplayRows(
                            t || this.getDisplayRows(e - 1).slice(0),
                            e,
                        );
                    }
                case "end":
        ...
        initializeRenderer() {
            ...
            (e =
                ...
                ? ((this.renderMode = this.table.options.renderVertical),
                  ...
                  this.renderer.initialize(),
                  (!this.table.element.clientHeight &&
                      !this.table.options.height) ||
        ...
        bindPseudoEvents() {
            Object.keys(this.pseudoTrackers).forEach((e) => {
                (this.pseudoTrackers[e].subscriber = this.pseudoMouseEnter.bind(
                    ...
                    this.subscribe(
                        e + "-mouseover",
                        this.pseudoTrackers[e].subscriber,
                    );
            }),
            ...
            for (let i of t)
                for (let t of e) {
                    ...
                    this.subscriptionChange(
                        e,
                        this.subscriptionChanged.bind(this, i, t),
                    );
                }
                ...
                : (this.dispatchExternal("dataLoading", e),
                  ...
                  this.confirm("data-loading", [e, t, i, o])
                      ? ((this.loading = !0),
                        ...
                        (t = this.mapParams(
                            t,
                            this.table.options.dataSendParams,
                        )),
                        this.chain(
                            "data-load",
                            [e, t, i, o],
    ...
    class E {
        ...
        _debugDispatch() {
            ...
            return (
                ...
                (!0 === this.debug || this.debug.includes(t)) &&
                    console.log(...e),
    ...
    class R extends e {
        ...
        check(e, t) {
            ...
            return (
                ...
                t
                    ? ((i =
                          i + ", Please use the %c" + t + "%c option instead"),
                      this._warnUser(
                          i,
                          "font-weight: bold;",
                          "font-weight: normal;",
    ...
    var L = {
        ...
        fitColumns: function (e, t) {
            ...
            function p(e, t, i, s) {
                ...
                function b(e) {
                    return (
                        u(e.width) - i * (e.column.definition.widthShrink || 0)
                    );
                }
                return (
    ...
    class S extends k {
        ...
        initializeColumn(e) {
            e.definition.widthGrow &&
                ...
                e.definition.widthShrink &&
                    (e.definition.widthShrink = Number(
                        e.definition.widthShrink,
                    ));
        }
        getMode() {
            ...
            (e.moduleBindings = {}),
                (e.extendModule = function (t, i, s) {
                    if (e.moduleBindings[t]) {
                        ...
                        console.warn(
                            "Module Error - module does not exist:",
                            t,
                        );
                }),
                ...
                (e.prototype.bindModules = function () {
                    ...
                    t.sort((e, t) =>
                        e.moduleInitOrder > t.moduleInitOrder ? 1 : -1,
                    ),
                        i.sort((e, t) =>
                            e.moduleInitOrder > t.moduleInitOrder ? 1 : -1,
                        ),
    ...
    class O {
        ...
        _buildElement() {
            ...
            if ("TABLE" === t.tagName) {
                ...
                for (var o in s)
                    "object" == typeof s[o] &&
                        e.setAttribute(s[o].name, s[o].value);
                                  ...
                                  o
                                      ? (t++,
                                        o
                                            ...
                                            .catch((t) => {
                                                s(
                                                    "Update Error - Unable to update row",
                                                    e,
                                                    t,
                                                );
                                            }))
                                      : s(
                                            "Update Error - Unable to find row",
                                            e,
                                        );
                              })
        ...
        deleteRow(e) {
            ...
            return (
                t.sort((e, t) =>
                    this.rowManager.rows.indexOf(e) >
                    this.rowManager.rows.indexOf(t)
                        ? 1
                        : -1,
                ),
                t.forEach((e) => {
        ...
        updateRow(e, t) {
            ...
            return (
                ...
                i
                    ? i
                          .updateData(t)
                          .then(() => Promise.resolve(i.getComponent()))
            ...
            this.initGuard(),
                s
                    ? o
                        ...
                        : console.warn(
                              "Move Error - No matching column found:",
                              o,
                          )
    ...
    class W extends k {
        ...
        initialize() {
            (this.loaderPromise =
                ...
                (this.urlGenerator =
                    this.table.options.ajaxURLGenerator ||
                    W.defaultURLGenerator),
                ...
                ? this.loaderPromise(e, i, t).then(
                      (i) => (
                          this.table.options.ajaxResponse &&
                              (i = this.table.options.ajaxResponse.call(
                                  this.table,
                                  e,
                                  t,
                                  i,
            ...
            return new Promise((o, n) => {
                if (
                    ...
                    if (
                        (s =
                            "object" ==
                            typeof this.table.options.ajaxContentType
                      ...
                      fetch(e, t)
                          .then((e) => {
                              e.ok
                                  ...
                                  : (console.error(
                                        "Ajax Load Error - Connection Error: " +
                                            e.status,
                                        e.statusText,
                                    ),
                                    n(e));
                    ...
                    this.table.element.addEventListener("copy", (e) => {
                        ...
                        this.blocked ||
                            ...
                            this.customSelection
                                ...
                                : ((s =
                                      this.table.modules.export.generateExportList(
                                          this.table.options
                                              .clipboardCopyConfig,
                                          this.table.options
                                              .clipboardCopyStyled,
                                  ...
                                  (t = (i =
                                      this.table.modules.export.generateHTMLTable(
                                          s,
                                      ))
        ...
        mutateData(e) {
            ...
            return (
                Array.isArray(e)
                    ? e.forEach((e) => {
                          t.push(
                              this.table.modules.mutator.transformRow(
                                  e,
                                  "clipboard",
                              ),
                          );
    ...
    var U = {
        ...
        unique: function (e, t, i) {
            return e.filter((t, i) => (e || 0 === t) && e.indexOf(t) === i)
                .length;
        },
    };
    class X extends k {
        ...
        initialize() {
            (this.genColumn = new n({ field: "value" }, this)),
                ...
                this.subscribe(
                    "redraw-restored",
                    this.restoreRedraw.bind(this),
                ),
                this.subscribe(
                    "table-redrawing",
                    this.resizeHolderWidth.bind(this),
                ),
                this.subscribe(
                    "column-resized",
                    this.resizeHolderWidth.bind(this),
        ...
        scrollHorizontal(e) {
            this.botInitialized &&
                this.botRow &&
                (this.botElement.scrollLeft = e);
        }
        recalc(e) {
            var t, i;
            if (
                !this.blockCheck() &&
                (this.topInitialized || this.botInitialized)
            ) {
                ...
                e.forEach((e) => {
                    if (
                        ...
                        var i = this.rowsToData(
                            this.table.modules.dataTree.getFilteredTreeChildren(
                                e,
                            ),
                        );
                        t = t.concat(i);
                        ...
                        this.genColumn.setField(s.getField()),
                            ...
                            this.table.modExists("format")
                                ? (this.genColumn.modules.format = {
                                      formatter:
                                          this.table.modules.format.getFormatter(
                                              s.definition[e + "CalcFormatter"],
                                          ),
                                      params:
                                          s.definition[
                                              e + "CalcFormatterParams"
                                          ] || {},
                                  })
                                : (this.genColumn.modules.format = {
                                      formatter:
                            ...
                            (this.genColumn.definition.cssClass =
                                s.definition.cssClass);
            ...
            return (
                s &&
                    ...
                    (Array.isArray(s.children) ||
                        (s.children = this.generateChildren(e)),
                ...
                switch (e.type) {
                    ...
                    case "row":
                        e.columns.forEach((e) => {
                            e &&
                                (t[
                                    e.component.getTitleDownload() ||
                                        e.component.getField()
                                ] = e.value);
                        }),
                            s.push(t);
                }
        ...
        triggerDownload(e, t, i, s, o) {
            ...
            r &&
                (o
                    ...
                    : ((s =
                          s ||
                          "Tabulator." + ("function" == typeof i ? "txt" : i)),
    ...
    class $ {
                ...
                this.params.maxWidth &&
                    (!0 === this.params.maxWidth
                        ...
                        : "number" == typeof this.params.maxWidth
                          ? (this.listEl.style.maxWidth =
                                this.params.maxWidth + "px")
                          : (this.listEl.style.maxWidth =
                                this.params.maxWidth));
        }
        _createInputElement() {
            ...
            return (
                this.params.mask && Y(t, this.params),
            ...
            return (
                ...
                (e.placeholderEmpty =
                    void 0 === e.placeholderEmpty
                        ...
                        : e.placeholderEmpty),
                (e.filterDelay =
                    void 0 === e.filterDelay ? 300 : e.filterDelay),
                ...
                this.params.values
                    ...
                    : this.params.valuesURL
                      ...
                      : "function" == typeof this.params.valuesLookup
                        ? (t = this.params.valuesLookup(
                              this.cell,
                              this.input.value,
                          ))
                        : this.params.valuesLookup &&
                          (t = this._uniqueColumnValues(
                              this.params.valuesLookupField,
                          )),
        ...
        _addPlaceholder(e) {
            ...
            "function" == typeof e &&
                (e = e(this.cell.getComponent(), this.listEl)),
                e &&
                    (this._clearList(),
                    e instanceof HTMLElement
                        ? (t = e)
        ...
        _defaultSortFunction(e, t) {
            var i,
                ...
                d = 0;
            if (
                ("desc" === this.params.sort && ([e, t] = [t, e]), e || 0 === e)
            ) {
                if (t || 0 === t) {
            ...
            if (!this.filtered || e.visible) {
                if (!i) {
                    if (
                        ...
                        i.classList.add(
                            "tabulator-edit-list-group-level-" + e.level,
                        ),
                        e.elementAttributes &&
                            "object" == typeof e.elementAttributes)
                    )
                        for (let t in e.elementAttributes)
                            "+" == t.charAt(0)
                                ? ((t = t.slice(1)),
                                  i.setAttribute(
                                      t,
                                      this.input.getAttribute(t) +
                                          e.elementAttributes["+" + t],
                                  ))
                                : i.setAttribute(t, e.elementAttributes[t]);
                    e.group
                        ? i.addEventListener(
                              "click",
                              this._groupClick.bind(this, e),
                          )
                        : i.addEventListener(
                              "click",
                              this._itemClick.bind(this, e),
                          ),
                        i.addEventListener(
                            "mousedown",
                            this._preventBlur.bind(this),
                        ),
                        (e.element = i);
                }
                this._styleItem(e),
        ...
        _showList() {
            ...
            if (this.input.parentNode) {
                ...
                this._setListWidth(),
                    ...
                    e ||
                        setTimeout(() => {
                            this.popup.hideOnBlur(
                                this._resolveValue.bind(this, !0),
                            );
                        }, 10);
            }
        }
        ...
        date: function (e, t, i, s, o) {
            ...
            function c() {
                ...
                if ((null == l && "" !== t) || t !== l) {
                    if (t && n)
                        switch (
                            ((e = a.fromFormat(String(t), "yyyy-MM-dd")), n)
                        ) {
                            case !0:
                                t = e;
                                break;
                ...
                a.addEventListener("keydown", function (e) {
                    switch (e.keyCode) {
                        case 39:
                            e.preventDefault(),
                                (p.style.width =
                                    p.clientWidth + a.clientWidth / 100 + "px");
                            break;
                        case 37:
                            e.preventDefault(),
                                (p.style.width =
    ...
    class Q extends k {
        ...
        initialize() {
            this.subscribe("cell-init", this.bindEditor.bind(this)),
                ...
                this.subscribe(
                    "cell-value-changed",
                    this.updateCellClass.bind(this),
                ),
                this.subscribe(
                    "column-layout",
                    this.initializeColumnCheck.bind(this),
        ...
        navigatePrev(e = this.currentCell, t) {
            var i, s;
            if (e) {
                if ((t && t.preventDefault(), (i = this.navigateLeft())))
                    return !0;
                if (
        ...
        navigateNext(e = this.currentCell, t) {
            var i, s;
            if (e) {
                if ((t && t.preventDefault(), (i = this.navigateRight())))
                    return !0;
                if (
            ...
            if (this.currentCell) {
                ...
                this.clearEditor(!0),
                    ...
                    e.column.definition.cellEditCancelled &&
                        e.column.definition.cellEditCancelled.call(
                            this.table,
                            t,
                        ),
                ...
                if ((t && t.stopPropagation(), this.allowEdit(e) || i)) {
                    if (
                        ...
                        this.mouseClick &&
                            ...
                            e.column.definition.cellClick &&
                                e.column.definition.cellClick.call(
                                    this.table,
                                    t,
                                    o,
                                )),
                        ...
                        (s = e.column.modules.edit.editor.call(
                            ...
                            function (t) {
                                if (r.currentCell === e) {
                                    ...
                                    return !0 === i ||
                                        "highlight" ===
                                            r.table.options.validationMode
                                        ? (r.clearEditor(),
                                          e.modules.edit ||
                                              (e.modules.edit = {}),
                                          (e.modules.edit.edited = !0),
                                          -1 == r.editedCells.indexOf(e) &&
                                              r.editedCells.push(e),
                                          e.setValue(t, !0),
                                          !0 === i)
                                        : ((r.invalidEdit = !0),
                    ...
                    for (
                        l.classList.add("tabulator-editing"),
                            e.row
                                .getElement()
                                .classList.add("tabulator-editing"),
    ...
    class ie extends k {
        ...
        columnVisCheck(e) {
            ...
            return (
                "function" == typeof t &&
                    (t = t.call(this.table, e.getComponent())),
                ...
                if (
                    ...
                    for (let i = 1; i < e.height; i++)
                        void 0 === t[s + i] && (t[s + i] = []),
                            t[s + i].push(!1);
                if (e.width > 1)
                    for (let i = 1; i < e.width; i++) t[s].push(!1);
                e.subGroups &&
                ...
                (e = e.filter((e) => {
                    ...
                    switch (e.type) {
                        ...
                        case "row":
                            t.forEach((e) => {
                                n.push(
                                    new te(e._column.getFieldValue(o), e, 1, 1),
                                );
                            }),
                                this.table.options.dataTree &&
                                    !1 !== this.config.dataTree &&
        ...
        generateTableElement(e) {
            ...
            return (
                (r.rowFormatter =
                    null !== n ? n : this.table.options.rowFormatter),
                this.table.options.dataTree &&
                    !1 !== this.config.dataTree &&
                    this.table.modExists("columnCalcs") &&
                    (r.treeElementField =
        ...
        lookupTableStyles() {
            ...
            return (
                this.cloneTableStyle &&
                    ...
                    e.firstRow &&
                        ((e.styleCells =
                            e.firstRow.getElementsByClassName(
                                "tabulator-cell",
                            )),
        ...
        generateGroupElement(e, t, i) {
            ...
            return (
                ...
                n.component.isVisible() &&
                    s.classList.add("tabulator-group-visible"),
                    ...
                    if (o) {
                        ...
                        d instanceof Node
                            ...
                            (r =
                                ...
                                l.definition.align &&
                                    (a.style.textAlign = l.definition.align)),
                            this.table.options.dataTree &&
                                !1 !== this.config.dataTree &&
                                ((t.treeElementField &&
                                    t.treeElementField == l.field) ||
    ...
    var se = {
        ...
        keywords: function (e, t, i, s) {
            var o = e
                    .toLowerCase()
                    .split(void 0 === s.separator ? " " : s.separator),
        ...
        ends: function (e, t, i, s) {
            return null == e
                ? t === e
                : null != t &&
                      String(t).toLowerCase().endsWith(e.toLowerCase());
        },
        in: function (e, t, i, s) {
    ...
    class oe extends k {
            ...
            if (
                ...
                switch (
                    ...
                    case "string":
                        c.table.modules.edit.editors[e.definition.headerFilter]
                            ? ((o =
                                  c.table.modules.edit.editors[
                                      e.definition.headerFilter
                                  ]),
                ...
                if (o) {
                    if (
                        ...
                        (h =
                            "function" ==
                            typeof (h = e.definition.headerFilterParams || {})
                                ? h.call(c.table, r)
                                : h),
                        !(n = o.call(
                    ...
                    c.langBind(
                        ...
                        n.addEventListener("focus", (e) => {
                            var t =
                                this.table.columnManager.contentsElement
                                    .scrollLeft;
        ...
        setFilter(e, t, i, s) {
            (this.filterList = []),
                Array.isArray(e) ||
                    (e = [{ field: e, type: t, value: i, params: s }]),
                this.addFilter(e);
        }
        addFilter(e, t, i, s) {
            var o = !1;
        ...
        clearHeaderFilter() {
            (this.headerFilters = {}),
                ...
                this.headerFilterColumns.forEach((e) => {
                    void 0 !== e.modules.filter.value &&
                        delete e.modules.filter.value,
                ...
                if (
                    ...
                    n instanceof u
                        ? (s.addEventListener("change", (e) => {
                              "click" ===
                                  this.table.options.selectableRangeMode && o
                                  ? (o = !1)
                                  : n.toggleSelect();
                          }),
    ...
    class ae extends k {
        ...
        initialize() {
            this.subscribe("cell-layout", this.layoutCell.bind(this)),
                ...
                this.subscribe(
                    "layout-refreshing",
                    this.blockLayout.bind(this),
                ),
                this.subscribe(
                    "layout-refreshed",
                    this.unblockLayout.bind(this),
                ),
                this.subscribe(
                    "scrollbar-vertical",
                    this.adjustForScrollbar.bind(this),
        ...
        layoutColumnPosition(e) {
            ...
            this.leftColumns.forEach((s, o) => {
                if (
                    ...
                    (s.modules.frozen.margin =
                        s.modules.frozen.marginValue + "px"),
                    ...
                    t.includes(n) || (this.layoutElement(n, s), t.push(n)),
                        s.modules.frozen.edge &&
                            n.classList.add(
                                "tabulator-frozen-" + s.modules.frozen.position,
                            );
                ...
                this.rightColumns.forEach((t, i) => {
                    (t.modules.frozen.marginValue = s),
                        (t.modules.frozen.margin =
                            t.modules.frozen.marginValue + "px"),
                        ...
                        t.parent.isGroup
                            ? this.layoutElement(
                                  this.getColGroupParentElement(t),
                                  t,
                              )
    ...
    class de {
            ...
            return (
                ...
                this.visible
                    ...
                    : this.groupList.length ||
                      ...
                      (this.groupManager.table.modExists("columnCalcs") &&
                          (this.groupManager.table.modules.columnCalcs.hasTopCalcs() &&
                              this.groupManager.table.options
        ...
        getComponent() {
            return (
                this.component || (this.component = new he(this)),
                this.component
            );
        }
    }
    class ce extends k {
        ...
        initialize() {
            this.subscribe("table-destroy", this._blockRedrawing.bind(this)),
                ...
                this.subscribe(
                    "rows-wiped",
                    this._restore_redrawing.bind(this),
                ),
                this.table.options.groupBy &&
                    ...
                    e.forEach((e, t) => {
                        ...
                        (i =
                            "function" == typeof e
                                ? e
                                : (s =
                                        this.table.columnManager.getColumnByField(
                                            e,
                                        ))
                                  ? function (e) {
        ...
        rowDeleted(e) {
            ...
            this.table.options.groupBy
                ? (t = (i = e
                      .getComponent()
                      .getGroup()
                      ._getSelf().rows).indexOf(e)) && (t = i[t - 1])
    ...
    class be extends k {
        ...
        initialize() {
            this.initializeExternalEvents(),
                ...
                this.subscribe(
                    "scroll-horizontal",
                    this.clearTouchWatchers.bind(this),
                ),
                this.subscribe(
                    "scroll-vertical",
                    this.clearTouchWatchers.bind(this),
                ...
                try {
                    document.selection
                        ? ((i =
                          ...
                          i.select())
                        : window.getSelection &&
                          ((i = document.createRange()).selectNode(
                              t.getElement(),
                          ),
                          window.getSelection().removeAllRanges(),
        ...
        handleTouch(e, t, i, s) {
            ...
            switch (("column" === e && (e = "header"), t)) {
                ...
                case "end":
                    o.tap &&
                        ((o.tap = null), this.dispatchEvent(e + "Tap", i, s)),
                        o.tapDbl
                            ? (clearTimeout(o.tapDbl),
                              (o.tapDbl = null),
                ...
                e.preventDefault(),
                    t.displayRowsCount &&
                        (i <= s
                            ? (t.element.scrollTop = i)
                            : t.scrollToRow(
                                  t.getDisplayRows()[t.displayRowsCount - 1],
                              )),
                    this.table.element.focus();
            },
    ...
    class ve extends k {
        ...
        initializeColumn(e) {
            ...
            t.headerContextMenu &&
                ...
                ((this.columnSubscribers.headerContextMenu =
                    this.loadMenuTableColumnEvent.bind(
                        this,
                        "headerContextMenu",
                    )),
                this.subscribe(
                ...
                o - s < this.autoScrollMargin &&
                    (this.autoScrollTimeout ||
                        (this.autoScrollTimeout = setTimeout(() => {
                            (t = Math.max(0, s - 5)),
                                (this.table.rowManager.getElement().scrollLeft =
                                    t),
                                (this.autoScrollTimeout = !1);
                        }, 1))),
            ...
            this.connectionSelectorsTables &&
                ...
                this.connectionSelectorsElements &&
                    ...
                    this.connectionSelectorsElements.forEach((e) => {
                        "string" == typeof e
                            ? (this.connectionElements =
                                  this.connectionElements.concat(
    ...
    (Ce.prototype.receivers = {
        ...
        replace: function (e, t, i) {
            return (
                !!t &&
                (this.table.addRow(e.getData(), void 0, t), t.delete(), !0)
            );
        },
    }),
    ...
    class Re extends k {
            ...
            return (
                t
                    ? o.length
                        ? (i = o[0])
                        : s.activeRows.length &&
                          ((i = s.activeRows[s.activeRows.length - 1]),
                          (t = !1))
                    : o.length &&
            ...
            e ||
                ...
                this.pageSizeSelect &&
                    ...
                    this.pageSizeSelect.addEventListener("change", (e) => {
                        this.setPageSize(
                            "true" == this.pageSizeSelect.value ||
                ...
                this.table.options.paginationElement ||
                    (this.table.options.paginationCounter &&
                        (this.table.options.paginationCounterElement
                            ? this.table.options
                                  .paginationCounterElement instanceof
                              HTMLElement
        ...
        _setPageButtons() {
            ...
            1 == this.page
                ...
                this.page == this.max
                    ? ((this.lastBut.disabled = !0),
                      (this.nextBut.disabled = !0))
        ...
        getRows(e) {
            ...
            if ("local" == this.mode) {
                ...
                return (
                    this._setPageCounter(r.length, n, o ? r.indexOf(o) + 1 : 0),
                    t
                );
            }
            return (
            ...
            return (
                (t = t || []).forEach((t, s) => {
                    ...
                    n &&
                        ...
                        n.columns &&
                            (n.columns = this.mergeDefinition(
                                n.columns,
                                t.columns,
                            )),
                        i.push(n));
        ...
        initializeColumn(e) {
            ...
            t.headerContextPopup &&
                ...
                t.contextPopup &&
                    ...
                    ((this.columnSubscribers.contextPopup =
                        this.loadPopupTableCellEvent.bind(
                            this,
                            "contextPopup",
                        )),
                    this.subscribe(
                    ...
                    value: function () {
                        ...
                        return (
                            i.blocked ||
                                ...
                                i.data.length &&
                                    (s =
                                        i.table.rowManager.getRowFromDataObject(
                                            i.data[0],
                                        )) &&
                                    s.deleteActual(),
                ...
                Object.defineProperty(this.data, "splice", {
                    ...
                    value: function () {
                        ...
                        if (!i.blocked && t === i.currentVersion) {
                            if (
                                ...
                                l &&
                                    ((s =
                                        ...
                                        ? l.forEach((e) => {
                                              i.table.rowManager.addRowActual(
                                                  e,
                                                  !0,
                                                  s,
                                                  !0,
                            ...
                            (l || 0 !== a) &&
                                i.table.rowManager.reRenderInPosition(),
    ...
    class De extends k {
        ...
        initializeEventWatchers() {
            this.initialized ||
                ...
                this.subscribe(
                    "column-hide",
                    this.deInitializeColumn.bind(this),
                ),
                this.subscribe(
                    "column-show",
                    this.columnLayoutUpdated.bind(this),
        ...
        columnWidthUpdated(e) {
            e.modules.frozen &&
                (this.table.modules.frozenColumns.leftColumns.includes(e)
                    ...
                    : this.table.modules.frozenColumns.rightColumns.includes(
                          e,
                      ) &&
                      this.table.modules.frozenColumns.rightColumns.forEach(
                          (e) => {
        ...
        reinitializeColumn(e) {
            ...
            e.cells.forEach((i) => {
                i.modules.resize &&
                    ...
                    (t &&
                        ((i.modules.resize.handleEl.style[
                            e.modules.frozen.position
                        ] = t),
                ...
                e.modules.resize &&
                    ...
                    (t &&
                        (e.modules.resize.handleEl.style[
                            e.modules.frozen.position
                        ] = t),
            ...
            if (
                ...
                l.addEventListener("mousedown", h),
                    ...
                    i.modules.frozen &&
                        ...
                        (l.style[i.modules.frozen.position] =
                            this.frozenColumnOffset(i))),
                    (r.handleEl = l),
        ...
        _mouseDown(e, t, i) {
            ...
            function o(e) {
                ...
                if (
                    ...
                    s.table.options.resizableColumnFit &&
                        s.nextColumn &&
                        (!i || !o))
                ) {
                    ...
                    a > 0 &&
                        ...
                        s.nextColumn &&
                            s.nextColumn.setWidth(s.nextColumn.getWidth() - a);
                }
            ...
            function n(e) {
                s.startColumn.modules.edit &&
                    (s.startColumn.modules.edit.blocked = !1),
                    s.table.browserSlow &&
                        t.modules.resize &&
                        t.modules.resize.variableHeight &&
                        t.checkCellHeights(),
                    ...
                    s.startWidth !== t.getWidth() &&
                        ...
                        s.table.externalEvents.dispatch(
                            "columnResized",
                            t.getComponent(),
                        ));
            }
            s.table.element.classList.add("tabulator-block-select"),
                e.stopPropagation(),
                s.startColumn.modules.edit &&
                    (s.startColumn.modules.edit.blocked = !0),
                (s.startX =
            ...
            if (this.table.options.autoResize) {
                ...
                (this.tableHeight = t.element.clientHeight),
                    ...
                    t.element.parentNode &&
                        ...
                        (this.containerWidth =
                            t.element.parentNode.clientWidth)),
                    ...
                    "virtual" === t.rowManager.getRenderMode()
                        ...
                        : ((this.binding = function () {
                              (!t.browserMobile ||
                                  (t.browserMobile &&
                                      !t.modules.edit.currentCell)) &&
                                  (t.columnManager.rerenderColumns(!0),
                                  t.redraw());
                          }),
                          window.addEventListener("resize", this.binding)),
                    this.subscribe(
                        "table-destroy",
                        this.clearBindings.bind(this),
                    );
            }
        }
        ...
        clearBindings() {
            this.binding && window.removeEventListener("resize", this.binding),
                ...
                this.containerObserver &&
                    this.containerObserver.unobserve(
                        this.table.element.parentNode,
                    );
        }
    }
        ...
        generateCollapsedRowContent(e) {
            ...
            if (e.modules.responsiveLayout) {
                for (t = e.modules.responsiveLayout.element; t.firstChild; )
                    t.removeChild(t.firstChild);
                (i = this.collapseFormatter(
                    this.generateCollapsedRowData(e),
                )) && t.appendChild(i);
            }
        }
                ...
                e.forEach(function (e) {
                    ...
                    o.appendChild(r),
                        ...
                        e.value instanceof Node
                            ? ((i = document.createElement("div")).appendChild(
                                  e.value,
                              ),
                              n.appendChild(i))
                            : (n.innerHTML = e.value),
        ...
        _deselectRow(e, t) {
            ...
            if (n) {
                if (
                    ...
                    return (
                        (s = n.getElement()) &&
                            s.classList.remove("tabulator-selected"),
        ...
        _rowSelectionChanged(e, t = [], i = []) {
            this.headerCheckboxElement &&
                (0 === this.selectedRows.length
                    ...
                    : this.table.rowManager.rows.length ===
                        this.selectedRows.length
    ...
    function Oe(e, t, i, s, o, n, r) {
        ...
        console.error(
            "Sort Error - 'datetime' sorter is dependant on luxon.js",
        );
    }
                    ...
                    ? (i.forEach(function (e, i) {
                          ...
                          e.column &&
                              ((o = e.column.modules.sort) &&
                                  (o.sorter ||
                                      (o.sorter = t.findSorter(e.column)),
                                  (e.params =
        ...
        _sortItems(e, t) {
            ...
            e.sort((e, s) => {
                for (var o, n = i; n >= 0; n--) {
                    ...
                    if (
                        0 !==
                        (o = this._sortRow(e, s, i.column, i.dir, i.params))
                    )
                        break;
                }
                return o;
        ...
        loadTooltip(e, t, i) {
            ...
            "function" == typeof i &&
                ...
                (i || 0 === i || !1 === i) &&
                    ...
                    "function" == typeof n &&
                        this.popupInstance.renderCallback(n),
            ...
            return (
                !0 !== s &&
                    setTimeout(() => {
                        e
                            .getElement()
                            .classList.add("tabulator-validation-fail"),
                            this.dispatchExternal(
                                "validationFailed",
                                e.getComponent(),
                                t,
