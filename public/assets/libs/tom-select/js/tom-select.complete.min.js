        ...
        off(t, i) {
            ...
            0 !== s
                ? e(t, (e) => {
                      ...
                      const t = this._events[e];
                      void 0 !== t &&
                          (t.splice(t.indexOf(i), 1), (this._events[e] = t));
                  })
                : (this._events = {});
        }
        trigger(t, ...i) {
            ...
            for (let t = 0; t < e.length; t++) {
                ...
                for (const e of s) {
                    ...
                    if (!i || 1 == i.length || i.end <= t)
                        ...
                        let s = e.clone(t, i);
                        const n = r.length;
                        s.add({ start: t, end: t + n, length: n, substr: r }),
                            l.push(s);
                    } else a.add("3");
                }
                if (l.length > 0) {
    ...
    class de extends (function (e) {
        ...
        constructor(e, t) {
            ...
            if (
                ...
                n.controlInput
                    ? ((p = j(n.controlInput)), (this.focus_node = p))
                    : ((p = j("<input/>")), (this.focus_node = l));
            (this.wrapper = r),
                (this.dropdown = a),
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) &&
                ...
                t.load &&
                    t.loadThrottle &&
                    (t.load = ee(t.load, t.loadThrottle)),
                se(s, "mousemove", () => {
                    e.ignoreHover = !1;
                }),
                se(
        ...
        sync(e = !0) {
            const t = this,
                i = e
                    ? ae(t.input, { delimiter: t.settings.delimiter })
                    : t.settings;
        ...
        setTextboxValue(e = "") {
            ...
            t.value !== e &&
                ((t.value = e), V(t, "update"), (this.lastValue = e));
        }
        getValue() {
        ...
        refreshOptions(e = !0) {
            ...
            const b = (e, t) => {
                ...
                return (
                    (i = p.length),
                    p.push({ fragment: s, order: t, optgroup: e }),
                    [i, s]
                );
            };
            for (t = 0; t < n; t++) {
        ...
        addItems(e, t) {
            ...
            const n = (s = s.filter((e) => -1 === i.items.indexOf(e)))[
                s.length - 1
            ];
            s.forEach((e) => {
        ...
        deleteSelection(e) {
            ...
            for (ie(e, !0), void 0 !== s && r.setCaret(s); l.length; )
                r.removeItem(l.pop());
            return (
                r.inputState(), r.positionDropdown(), r.refreshOptions(!1), !0
            );
        }
        shouldDelete(e, t) {
        ...
        de.define("checkbox_options", function (e) {
            ...
            var n = function (e, t) {
                    t
                        ...
                        : ((e.checked = !1),
                          s.checkedClassNames &&
                              e.classList.remove(...s.checkedClassNames),
                          s.uncheckedClassNames &&
            ...
            t.hook("after", "setupTemplates", () => {
                ...
                t.settings.render.option = (i, o) => {
                    ...
                    return (
                        n(l, !!(a && t.items.indexOf(a) > -1)), r.prepend(l), r
                    );
                };
            }),
                t.on("item_remove", (e) => {
            ...
            (e.settings.shouldOpen = !0),
                ...
                e.on("initialize", () => {
                    ...
                    e.hook("instead", "onBlur", (i) => {
                        ...
                        e.hook("before", "close", () => {
                            e.isOpen &&
                                e.focus_node.focus({ preventScroll: !0 });
                        });
                });
        }),
        ...
        de.define("virtual_scroll", function () {
            ...
            if (
                (e.settings.shouldLoadMore ||
                    (e.settings.shouldLoadMore = () => {
                        if (
                            n.clientHeight / (n.scrollHeight - n.scrollTop) >
                            0.9
                        )
                            return !0;
                        if (e.activeOption) {
            ...
            (e.setNextUrl = (e, t) => {
                ...
                e.hook("instead", "canLoad", (i) =>
                    i in r ? c(i) : t.call(e, i),
                ),
                e.hook("instead", "loadCallback", (t, i) => {
                    if (l) {
                        if (o) {
                            const i = t[0];
                            void 0 !== i &&
                                (o.dataset.value = i[e.settings.valueField]);
                        }
